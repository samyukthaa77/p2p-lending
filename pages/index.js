						...
						<div className="row">
							<div className="col-lg-6 col-xl-5">
								<div className="text-container">
									<h1>
										Smarter & Better Investment Asset Class
									</h1>
									<p className="p-large">
										Get online personal loans at attractive
										interest rates through P2P Lending
									</p>
									<p className="p-large">
										Opportunity to earn high returns by
										lending money online to verified
										borrowers
									</p>
									<a
						...
						<div className="col-lg-12">
							...
							<div className="card">
								...
								<div className="card-body">
									...
									<p>
										The platform puts in place one of the
										highest data security and safety
										standards to keep your data protected
										and confidential at all times. RBI has
										already taken a cognizance of this
										innovation and come up with regulations
										for the sector.
									</p>
								</div>
							</div>
					...
					<div className="row">
						<div className="col-lg-12">
							...
							<p className="p-heading">
								Get P2P Loans at Attractive Interest Rates on
								Peer to Peer Lending Platform without any
								Prepayment Charges
							</p>
						</div>
					</div>
